# 🧱 BART'S CNN-ESQUE HALLUCINATION SHIT WE HARD BLOCK

HALLUCINATION_BLURBS = {
    ...
    "CNN.com's weekly, offbeat look",
    "CNN.com's weekly, offbeat look at life in the U.S.",
    "See www.charlottecnn.com for more.",
    "CNN",
    "Instagram",
